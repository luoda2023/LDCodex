...
export function App() {
  ...
  const refreshZedRemoteProjects = async (silent = false) => {
    ...
    if (result) {
      ...
      if (!silent || !isSuccessStatus(result.status)) showResultNotice("Zed Զ����Ŀ", result, { silentSuccess: true });
    }
    return result;
  };
  ...
  const openZedRemoteProject = async (
    ...
    if (result) {
      showResultNotice("Zed Զ�̴�", result);
  ...
  const forgetZedRemoteProject = async (project: ZedRemoteProject) => {
    ...
    if (result) {
      setZedRemoteProjects(result);
      showResultNotice("Zed Զ����Ŀ", result);
    }
  };

  const deleteLocalSession = async (session: LocalSession) => {
    const title = session.title || session.id;
    if (!window.confirm(`ɾ���Ự��${title}�����˲�����ɾ���������ݿ��¼�� rollout �ļ������������ݡ�`)) return;
    const result = await run(() =>
  ...
  const saveLaunchMode = async (launchMode: LaunchMode, silent = false, baseSettings: BackendSettings = settingsForm) => {
    ...
    if (result) {
      setSettings(result);
      setSettingsForm(normalizeSettings(result.settings));
      if (!silent) showNotice("ҳ����ǿģʽ", result.message, result.status);
    }
    return result;
  };
  ...
  const switchOfficialMode = async () => {
    ...
    if (result) showNotice("�ٷ���¼ģʽ", "���лعٷ���¼��ҳ����ǿ����Ϊ������ǿ��", result.status);
  };
  ...
  const switchPureApiMode = async () => {
    ...
    if (result) showNotice("�� API ģʽ", "���л����� API��ҳ����ǿ����Ϊ������ǿ��", result.status);
  };
  ...
  const switchRelayProfile = async (next: BackendSettings, previousActiveRelayId = settingsForm.activeRelayId) => {
    ...
    try {
      ...
      if (!isSuccessStatus(result.status)) {
        ...
        showNotice("ģ���л�", result.message, result.status);
        return;
      }
      ...
      showNotice("ģ���л�", relayProfileModeSwitchedText(currentSelected), result.status);
    } finally {
  ...
  return (
    <div className={`shell ${theme}`}>
      <header className="titlebar">
          ...
          <button className="titlebar-btn" onClick={(e) => { e.stopPropagation(); minimize(); }} title="��С��">_</button>
          <button className="titlebar-btn" onClick={(e) => { e.stopPropagation(); maximize(); }} title="���">&#x25A1;</button>
          <button className="titlebar-btn titlebar-close" onClick={(e) => { e.stopPropagation(); closeWindow(); }} title="�ر�">&#x2A2F;</button>
        </div>
      </header>
        ...
        <div className="sidebar-footer">
          <div className="sidebar-footer-brand" onClick={() => actions.openExternalUrl("https://Dicad.cn")}>
            ...
            <div className="sidebar-footer-info">
              ...
              <span className="sidebar-footer-slogan">AI���ܹ������</span>
            </div>
          </div>
        </div>
      </aside>
...
function OverviewScreen({
  ...
  return (
    <>
      ...
      <Panel>
        <CardHead title="������������״̬" detail={overview?.logs_path ?? "����״̬�ļ�"} />
        <CardContent>
...
function RelayScreen({
  ...
  return (
    <>
      <Panel>
        <CardHead title="ģ���б�" detail={`${normalized.relayProfiles.length} ��ģ������`} />
        <CardContent>
...
function EnhanceScreen({
  ...
  return (
    <>
      <Panel>
        <CardHead title="ҳ�湦����ǿ" detail="�Ựɾ������������Ŀ�ƶ���Timeline ���û��ű��Ƚ�������" />
        <CardContent>
          <label className="switch-row">
            ...
            />
            <span>
              <strong>���� LDCodex ҳ����ǿ</strong>
              <small>�رպ��ͣ��ɾ������������Ŀ�ƶ���Timeline�������غͲ˵�λ����ǿ��</small>
            </span>
          </label>
          <label className="switch-row">
            <input
          ...
          {form.launchMode === "relay" ? (
            <div className="hint-line">
              ...
              <span>��ǰΪ������ǿģʽ������г�������ǿ�ƽ�����ں�������ǿ�ư�װ�������ã�����ҳ�湦���Կ��á�</span>
            </div>
          ) : null}
          <div className="feature-switch-grid">
            ...
            <FeatureToggle title="ǿ�ƽ������" detail="�ָ� 1.1.9 ����ڽ�����ʽ��ǿ����ʾ�����ò����ڡ�" checked={form.codexAppPluginEntryUnlock} disabled={!masterEnabled || !patchMode} onChange={(value) => setEnhanceFlag("codexAppPluginEntryUnlock", value)} />
            ...
            <FeatureToggle title="�Ի� Timeline" detail="�ڶԻ��Ҳ���ʾ�û�����ʱ���ߣ�֧��ժҪ����ת��" checked={form.codexAppConversationTimeline} disabled={!masterEnabled} onChange={(value) => setEnhanceFlag("codexAppConversationTimeline", value)} />
          ...
          <div className="hint-line">
            ...
            <span>���ʹ�ùٷ�ģʽ��ٷ����� API ģʽ��ͨ������Ҫ�������г�������ǿ�ƽ�����ں�������ǿ�ư�װ��</span>
          </div>
          <Toolbar>
...
function ProxyScreen({
  ...
  const handleStop = async () => {
    ...
    } catch (_) { setLocalNotice({title:'���������', message: 'ֹͣʧ��', status: 'failed'}); }
    setChecking(false);
    refreshBridgeStatus();
    handleReadLogs();
  };
  ...
  return (
    <>
      <Panel>
        <CardHead title="���������" detail="LuoDaBridge �������������" />
        <CardContent>
          <div className="metric-list">
            <Metric label="����״̬" value={bridgeRunning ? '������' : '��ֹͣ'} />
            <Metric label="����˿�" value={bridgePort} />
          </div>
          <Toolbar>
            {!bridgeRunning ? (
            ...
            <Button variant="outline" onClick={() => setBridgeLogs('')}>
              <Trash2 className="h-4 w-4" />
              �����־
            </Button>
      ...
      <Panel>
        <CardHead title="������־" detail="���������������м�¼" />
        <CardContent>
          <div className="log-viewer">
            <pre>{bridgeLogs || '������־������ˢ����־'}</pre>
          </div>
        </CardContent>
      </Panel>
      <Panel>
        <CardHead title="��������" detail="�޸Ĵ���˿ڵȲ���" />
          <CardContent>
            <div className="settings-fields">
              ...
              <div className="hint-text">�޸Ķ˿ں���������������������Ч</div>
            </div>
          </CardContent>
      </Panel>
    </>
...
function SortableRelayProfileCard({
  ...
  return (
    ...
    >
      ...
      <span className="relay-index" title={profile.name || "δ����ģ��"}>
        {providerInitial(profile.name)}
      </span>
      <span className="relay-summary">
        <strong>{profile.name || "δ����ģ��"}</strong>
      ...
      <span className="relay-card-actions">
        <Button
          ...
          size="sm"
          title={disabled ? "ģ���л�������" : active ? "��ǰʹ����" : "��Ϊ��ǰ"}
...
function ContextScreen({
  ...
  return (
    <Panel fill>
      <CardHead title="Codex ��������" detail="�������� Codex �� MCP��Skills��Plugins���л�����ģ�Ͷ�����ϡ�" />
      <CardContent>
        <RelayContextManager
    ...
    <div className="relay-profile-editor">
      ...
      <div className="relay-fields">
        ...
        <Field className="relay-field-config-model" label="����ģ��">
          <Input
            ...
            placeholder="д�� config.toml �� model �ֶΣ����� gpt-5"
          />
        </Field>
          ...
          <Field className="relay-field-model-list" label="ģ���б�">
            <div className="relay-model-list-tools">
              <Textarea
                ...
                placeholder="ÿ��һ��ģ�ͣ����� qwen3-coder"
              />
              <Button
                onClick={async () => {
      ...
      {showApiFields && profile.protocol === "chatCompletions" ? (
        <div className="hint-line relay-protocol-hint">
          ...
          <span>�����λ�ͨ������ 127.0.0.1:37000 ת�� Responses API����Ҫ�� LDCodex ��� Codex��</span>
        </div>
      ) : null}
      <div className="hint-line relay-protocol-hint">
        <ShieldCheck className="h-4 w-4" />
  ...
  return (
    <div className="relay-context-panel">
      <div className="relay-context-head">
        <div>
          <strong>Codex ��������</strong>
          <span>MCP��Skills��Plugins ��Ϊȫ�����ö���������л�����ģ�Ͷ���ϲ���</span>
        </div>
      ...
      <div className="relay-context-summary">
        ��ǰ���� {visibleEntries.length} ��{label}����Щ��Ŀ������ģ�ͣ���д������ģ���л���� config.toml��
      </div>
      ...
      <div className="relay-file-panel">
        <div className="relay-file-head">
          <div>
            ...
            <span>{isActive ? "��ǰģ���л����д���Ԥ���������Ŀ��ر仯��������ӳ" : "�л�����ģ��ʱ��д���Ԥ���������Ŀ��ر仯��������ӳ"}</span>
          </div>
        </div>
        <SyncedTextarea
          ...
          <Button
            onClick={async () => {
              ...
              if (!split.common.trim() && !split.context.trim()) {
                await actions.showMessage("ͨ�������ļ�", "��ǰģ������ ��û�п���ȡ��ͨ�����á�", "failed");
                return;
              }
      ...
      <div className="relay-file-panel">
        <div className="relay-file-head">
          <div>
            ...
            <span>{isActive ? "��ǰʹ���У���ʱ�� ~/.codex/auth.json �����������Ϊ��ģ�� auth �浵" : "�л�����ģ��ʱ��д�� ~/.codex/auth.json"}</span>
          </div>
        </div>
        <SyncedTextarea
          className="relay-file-textarea"
...
function ModeSelector({ launchMode, actions }: { launchMode: LaunchMode; actions: Actions }) {
  return (
    <div className="mode-grid">
      ...
      >
        <strong>������ǿ</strong>
        <span>�ʺϹٷ���¼��ٷ����� API Key������Ựɾ������������Ŀ�ƶ���Timeline ���û��ű����رղ����������ǿ��</span>
      </button>
      <button
      ...
      >
        <strong>������ǿ</strong>
        <span>�ʺϴ� API�����ò����ڡ�ǿ�ư�װ���Ựɾ����������Ŀ�ƶ���ȫ��ҳ��������</span>
      </button>
    </div>
  );
}
...
function LatestLaunch({ status }: { status: LaunchStatus | null }) {
  ...
  return (
    <div className="metric-list">
      <Metric label="����״̬" value={status.status === "ok" ? "����" : status.status} />
...
function relayProfileEditorStatus(profile: RelayProfile, form: BackendSettings, isNew: boolean) {
  if (isNew) return "�½�ģ����Ҫ�ȱ��浽�б�";
  if (!form.relayProfilesEnabled) return "ģ�������ܿ����ѹرգ���ǰֻ�������ã���д�� Codex live �ļ�";
  return profile.id === form.activeRelayId ? "��ǰʹ����" : "�༭�󱣴��б�����л�ģʽʱ��ʹ��������";
}

function providerInitial(name: string) {
  const trimmed = (name || "ģ��").trim();
...
function relayProfileModeHelp(profile: RelayProfile): string {
  if (profile.relayMode === "official") {
    if (profile.officialMixApiKey) {
      return "��ģ�ͻᱣ��ٷ���¼ģʽ������������뵱ǰ API Key��";
    }
    return "��ģ�ͻ��лعٷ���¼ģʽ��ʹ�� ChatGPT �ٷ��˺š�";
  }
  if (profile.relayMode === "pureApi") {
    return "��ģ�ͻ�ͬʱд�� config.toml �� auth.json��";
  }
  return "��ģ�ͻᱣ��ٷ���¼ģʽ������������뵱ǰ API Key��";
}

function relayProfileModeSwitchedText(profile: RelayProfile): string {
  if (profile.relayMode === "pureApi") return "�Ѱ���ģ���л����� API��ҳ����ǿ����Ϊ������ǿ��";
  if (profile.officialMixApiKey) return "�Ѱ���ģ��ʹ�ùٷ���¼�������� API Key��";
  return "�Ѱ���ģ���лعٷ���¼��";
}
...
function relayProfileSwitchValidation(profile: RelayProfile): string | null {
  ...
  if (!profile.configContents.trim()) {
    return `ģ�͡�${profile.name || profile.id}��ȱ�ٶ������ã���ֹͣ�л��������ڸ�ģ�������ﱣ�����á�`;
  }
  if (profile.relayMode !== "official" || !authJsonHasOpenAiApiKey(profile.authContents)) return null;
  return "�ٷ���� API ��Ӧ�� auth.json �б��� OPENAI_API_KEY������������л���";
}
...
function createRelayProfile(settings: BackendSettings): RelayProfile {
  ...
  const next = {
    id,
    name: `ģ�� ${settings.relayProfiles.length + 1}`,
    model: "",
...
function zedRemoteSourceLabel(source: string) {
  if (source === "currentThread") return "��ǰ�Ự";
