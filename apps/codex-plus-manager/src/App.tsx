    ...
    <div className={`shell ${theme}`}>
      <header className="titlebar" data-tauri-drag-region>
        ...
        <div className="titlebar-controls">
          <button className="titlebar-btn" onClick={minimize} title="最小化">_</button>
          <button className="titlebar-btn" onClick={maximize} title="最大化">&#x25A1;</button>
          <button className="titlebar-btn titlebar-close" onClick={closeWindow} title="关闭">&#x2A2F;</button>
        </div>
      </header>
