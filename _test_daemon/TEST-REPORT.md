...
| 测试集 | 结果 |
|---|---|
| 功能接口测试（`run-tests.js`） | **144 / 144 全部通过** ✅（含 88.8.5 新增 T23 系列 7 项 + T24 系列 6 项；88.8.4 新增 T21 系列 4 项 + T22 系列 3 项） |
