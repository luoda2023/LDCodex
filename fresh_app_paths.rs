...
//! This file is derived from the Codex CLI project.
//! It has been cleaned up to fix Rust 1.95.0 compilation issues.
...
fn codex_prefix_str() -> String {
    let d = dot_char();
    vec!["OpenAI".to_string(), d, "Codex_".to_string()].concat()
}
