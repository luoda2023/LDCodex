...
$inputFile = "J:/codex-work/LDCodex/LDAI.png"
$outputFile = "J:/codex-work/LDCodex/apps/codex-plus-manager/src-tauri/icons/icon.ico"
...
Write-Host "icon.ico created successfully at $outputFile"
